...
class TransferWireRulesTest {
    ...
    fun rejectsWeakMalformedAndUppercaseEtags() {
        listOf(
            ...
            assertThrows(IllegalArgumentException::class.java) { TransferWireRules.strongSha256Etag(value) }
        }
    }

    @Test
    fun uploadOffsetCannotAdvancePastDeclaredSize() {
        assertEquals(1_048_576L, TransferWireRules.expectedOffset(0, 1_048_576, 2_000_000))
